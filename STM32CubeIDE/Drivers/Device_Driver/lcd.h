...
#define	LCD_CS_SET  LL_GPIO_SetOutputPin(GPIOC, LL_GPIO_PIN_14) //LCD_CS=1//GPIO_TYPE->BSRR=1<<LCD_CS    //Ƭѡ�˿�  	PB11
#define	LCD_RS_SET	LL_GPIO_SetOutputPin(GPIOC, LL_GPIO_PIN_0) //LCD_RS=1//GPIO_TYPE->BSRR=1<<LCD_RS    //����/����  PB10
#define	LCD_RST_SET	//LCD_RST=1//GPIO_TYPE->BSRR=1<<LCD_RST    //��λ			PB12

 							    
#define	LCD_CS_CLR  LL_GPIO_ResetOutputPin(GPIOC, LL_GPIO_PIN_14) //LCD_CS=0//GPIO_TYPE->BRR=1<<LCD_CS     //Ƭѡ�˿�  	PB11
#define	LCD_RS_CLR	LL_GPIO_ResetOutputPin(GPIOC, LL_GPIO_PIN_0) //LCD_RS=0//GPIO_TYPE->BRR=1<<LCD_RS     //����/����  PB10
